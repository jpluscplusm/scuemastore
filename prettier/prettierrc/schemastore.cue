...
_#Schema: {
	...
	#optionsDefinition: {
		...
		// Whether parse the .editorconfig file in your project and
		// convert its properties to the corresponding Prettier
		// configuration. This configuration will be overridden by
		// .prettierrc, etc.
